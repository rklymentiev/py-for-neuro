...
Second example shows how you can get take every number to the power of two using `for` loop.
...
Notes: List comprehensions allow to create a new list in a shorter way using `for` loops directly inside the list. However, sometimes such lines of codes become "harder" to read.
